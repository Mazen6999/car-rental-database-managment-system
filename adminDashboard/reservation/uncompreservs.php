    ...
    <div class="row">
            <div class="col-md-3">
                <br>
                    ...
                    <h2 align="middle" style="color:rgb(0, 0, 0)">Manage Uncompleted or Unpaid Reservations</h2>
                
            </div>

            <div class="col-md-6"><br><br>
            <u><b>Delete</b></u><br><form class="well form-horizontal" action="deleteUNCresv.php" method="post"  id="del_form"> 
                    
                    &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
                    &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<b>Enter Booking ID: &nbsp</b>
                    <input name="deleterserv" placeholder="Booking_ID"   type="text">
